	...
	<nav class="navbar navbar-expand-md navbar-dark" style="background-color: #17a158;">  
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item ">
					<a class="nav-link active" href="<?php echo site_url('peserta/smp') ?>">SMP<span class="sr-only"></span></a>
				</li>
				<li class="nav-item ">
					<a class="nav-link" href="<?php echo site_url('peserta/sma') ?>">SMA<span class="sr-only"></span></a>
				</li>
			</ul>
		</div>
	</nav>
