	...
	<nav class="navbar navbar-expand-md navbar-dark " style="background-color: #17a158;"> 
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault"> 
			<ul class="navbar-nav mr-auto"> 
				...
				<li class="nav-item "> 
					<a class="nav-link active" href="<?php echo site_url('output/pos4/smp') ?>">POS 4<span class="sr-only"></span></a> 
				</li>  
				<li class="nav-item "> 
			...
			<tr>
				<td>
					<div style="margin: 20px 0 20px 5rem">
						TINGKAT :
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/pos4/smp') ?>'">SMP</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/pos4/sma') ?>'">SMA</button>
					</div>
				</td>
				<td>
					<div style="margin: 20px 0 20px 5rem">
						Download Excel :
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/download_pos4/sd') ?>'">SD</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/download_pos4/smp') ?>'">SMP</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/download_pos4/sma') ?>'">SMA</button>
					</div>
				</td>
			</tr>
		</table>
