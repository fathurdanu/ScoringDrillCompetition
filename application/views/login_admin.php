...
<body>
  <nav class="navbar navbar-expand-md navbar-dark  " style="background-color: #17a158;">  
    <a class="navbar-brand" href="<?php echo site_url('admin/login') ?>">
  ...
  <center>	
    ...
    <center><h1 style="margin-top: 75px">Login Admin LBB</h1></center>
    <center><p>
      <?php 
    ...
    <form method="POST" action="<?php echo site_url('admin/cek_login') ?>">  
