	...
	<nav class="navbar navbar-expand-md navbar-dark " style="background-color: #17a158;"> 
		...
		<div class="collapse navbar-collapse" id="navbarsExampleDefault"> 
			<ul class="navbar-nav mr-auto"> 
				<li class="nav-item "> 
					<a class="nav-link active" href="<?php echo site_url('output/pos1/smp') ?>">POS 1<span class="sr-only"></span></a> 
				</li> 
				<li class="nav-item "> 
			...
			<tr>
				<td>
					<div style="margin: 20px 0 20px 5rem">
						TINGKAT :
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/pos1/sd') ?>'">SD</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/pos1/smp') ?>'">SMP</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/pos1/sma') ?>'">SMA</button>
					</div>
				</td>
				<td>
					<div style="margin: 20px 0 20px 5rem">
						Download Excel :
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/download_pos1/sd') ?>'">SD</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/download_pos1/smp') ?>'">SMP</button>
						<button class="button btn-success" onclick="location.href='<?php echo site_url('output/download_pos1/sma') ?>'">SMA</button>
					</div>
				</td>
			</tr>
		</table>
		<div class="card border-secondary col-sm-10 col-md-8 col-lg-6 mx-auto" style="min-width: 70rem; max-width: 95%">
